...
export default function App() {
  ...
  // 5. Typewriter state for name "MUKESHWAR RAUDRA"
  const [displayName, setDisplayName] = useState("");
  const fullName = "MUKESHWAR RAUDRA";
      ...
      <section id="home">
        ...
        <div className="home-center-container">
          ...
          <div className="portrait-container">
            <img src="/RESOURCE/Professor.png" alt="Professor portrait" className="portrait-img" />
          </div>

          {/* Floating tech badges */}
          <div className="badge-tile badge-left-upper badge-float-1">
            <div className="badge-hover-wrapper">
              <div className="badge-box-inner glass-panel badge-rotate-cw">
                <img src="/RESOURCE/Codesapiens.jpg" alt="Codesapiens" />
              </div>
            </div>
          </div>
          <div className="badge-tile badge-left-lower badge-float-2">
            <div className="badge-hover-wrapper">
              <div className="badge-box-inner glass-panel badge-rotate-ccw">
                <img src="/RESOURCE/Nexora.jpg" alt="Nexora" />
              </div>
            </div>
          </div>
          <div className="badge-tile badge-right-upper badge-float-3">
            <div className="badge-hover-wrapper">
              <div className="badge-box-inner glass-panel badge-rotate-ccw">
          ...
          <div className="badge-tile badge-right-lower badge-float-4">
            <div className="badge-hover-wrapper">
              <div className="badge-box-inner glass-panel badge-rotate-cw">
        ...
        <div className="about-content">
          ...
          <div className="about-right">
            <div className="about-portrait-frame">
              <img src="/RESOURCE/Professor.png" alt="Mukesh Framed Portrait" />
            </div>
          </div>
        </div>
      </section>
